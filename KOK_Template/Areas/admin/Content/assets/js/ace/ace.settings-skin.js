...
(function($ , undefined) {
  try {
      $('#skin-colorpicker').ace_colorpicker({ 'auto_pos': true });
      var skin = 'skin-3';
  ...
  function ChangeSkin(skin) {
      ...
      function applyChanges(skin_class) {
          ...
          if (skin_class == 'no-skin') {
              ...
              $('.skin-1 .table-header').css("background-color", "#222A2D");
              $('.skin-1 .navbar').css("background-color", "#222A2D");
              ...
              $('.skin-2 .table-header').css("background-color", "#C6487E");
              //$('.skin-2 .navbar').css("background-color", "#C6487E");
              ...
              $('.skin-3 .table-header').css("background-color", "#D0D0D0");
              //$('.skin-3 .navbar').css("background-color", "#D0D0D0");
