...
namespace TLLib
{
    ...
    public class Common
    {
        ...
        public void RecursiveFillTree(DataTable dtParent, int parentID, string parentColumnName, string displayColumnName, string valueColumnName, int increaseLevelCount, string IsShowOnMenu, string IsShowOnHomePage, string ProductID)
        {
            if (dt.Columns.Count == 0)
            {
                foreach (DataColumn dc in dtParent.Columns)
            ...
            dv.RowFilter = string.Format(parentColumnName + " = {0} AND IsAvailable = 1 " +
                ...
                (string.IsNullOrEmpty(ProductID) ? "" : " AND ProductID = " + ProductID)
            , parentID);
            ...
            if (dv.Count > 0 && (level <= increaseLevelCount - 1 || increaseLevelCount == -1))
            {
                foreach (DataRowView drv in dv)
                {
                    ...
                    obj[columnLength - 1] = level;
                    dt.Rows.Add(obj);
                    RecursiveFillTree(dtParent, int.Parse(drv[valueColumnName].ToString()), parentColumnName, displayColumnName, valueColumnName, increaseLevelCount, IsShowOnMenu, IsShowOnHomePage, ProductID);
                }
            }
        ...
        public void RecursiveFillTree1(DataTable dtParent, int parentID, string parentColumnName, string displayColumnName, string valueColumnName, int increaseLevelCount, string IsShowOnMenu, string IsShowOnHomePage, string SeparatorCharacter)
        {
            ...
            dv.RowFilter = string.Format(parentColumnName + " = {0} AND IsDeleted = 0 " +
            ...
            if (dv.Count > 0 && (level <= increaseLevelCount - 1 || increaseLevelCount == -1))
            {
                foreach (DataRowView drv in dv)
                {
                    ...
                    obj[columnLength - 1] = level;
                    dt.Rows.Add(obj);
                    RecursiveFillTree1(dtParent, int.Parse(drv[valueColumnName].ToString()), parentColumnName, displayColumnName, valueColumnName, increaseLevelCount, IsShowOnMenu, IsShowOnHomePage, SeparatorCharacter);
                }
            }
        ...
        public static bool SendMail(string strHost, int iPort, string strMailFrom, string strUserName, string strPassword, string strMailTo, string strCC, string strSubject, string strBody, bool bEnableSsl)
        {
            bool SendSuccess = false;
            try
            {
        ...
        public static bool SendMail(string strHost, int iPort, string strMailFrom,string strDisplayName, string strUserName, string strPassword, string strMailTo, string strCC, string strSubject, string strBody, bool bEnableSsl)
        {
            bool SendSuccess = false;
            try
            {
        ...
        public static bool SendMail(string strHost, int iPort, string strMailFrom, string strUserName, string strPassword, List<string> lstMailTo, List<string> lstCC, List<string> lstAttachment, string strSubject, string strBody, bool bEnableSsl)
        {
            bool SendSuccess = false;
            try
            {
        ...
        public static bool SendMail(string strHost, int iPort, string strMailFrom, string strDisplayName, string strUserName, string strPassword, List<string> lstMailTo, List<string> lstCC, List<string> lstAttachment, string strSubject, string strBody, bool bEnableSsl)
        {
            bool SendSuccess = false;
            try
            {
